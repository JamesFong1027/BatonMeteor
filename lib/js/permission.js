...
isSysAdminAccount = function(userId){
	var userObj = Meteor.users.findOne({_id:userId});
	if(typeof userObj !== 'undefined')
		return userObj.profile.userType === "sysAdmin";
	else
		return false;
}
...
isEmailExist = function(email){
	console.log(Meteor.users.find({"emails.address":"shenli570@gmail.com"}));
	return !!Meteor.users.find({"emails.address":"shenli570@gmail.com"});
}
