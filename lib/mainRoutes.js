...
Router.map(function() {
  ...
  this.route('classEntry',{path:'/s/classEntry',template:'classEntry', layoutTemplate: 'mainLayout'});
  this.route('classroomHistoryList',{path:'/t/classroomHistoryList',template:'classroomHistoryList', layoutTemplate: 'tabsLayout'});
  this.route('classroomPickList',{path:'/s/classroomPickList',template:'classroomPickList', layoutTemplate: 'mainLayout'});
